...
public class RecordIngestHelper extends CSVIngestHelper {
    ...
    private boolean indexAllFields;
    ...
    public void setup(Configuration config) {
        super.setup(config);
        this.helper = (RecordDataTypeHelper) super.helper;

        final String indexAllFieldsStr = config.get(INDEX_ALL_FIELDS,"false");
    ...
    protected CSVHelper createHelper() {
        return new RecordDataTypeHelper();
    }
    ...
    protected void processPreSplitField(Multimap<String,String> fields, String fieldName, String fieldValue) {
        ...
        fieldValue = RecordDataTypeHelper.expandFieldValue(fieldValue);
    ...
    public boolean isIndexListField(String field) {
        return indexAllFields ?  true :  super.isIndexListField(field);
    }

    @Override
    public boolean isReverseIndexListField(String field) {
        return indexAllFields ?  true :  super.isReverseIndexListField(field);
    }
